...
Kubernetes Security (formerly KubeClarity) is a tool for detection and management of Software Bill Of Materials (SBOM) and vulnerabilities of container images and filesystems. It scans both runtime K8s clusters and CI/CD pipelines for enhanced software supply chain security.

![](images/dashboard-screen.png)

Kubernetes Security is now part of the [Openclarity platform](https://openclarity.io).
